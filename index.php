...
<?php } ?>
  ...
  <li class="nav-item dropdown">
	...
	<div class="row">
			...
			<!-- Frequency Templates UI -->
              <div class="template-box mb-3">
                <div class="d-flex justify-content-between align-items-center mb-2">
                  <div><i class="fa-solid fa-layer-group me-2"></i><strong><?= __("Frequency Templates"); ?></strong></div>
                </div>

                <div class="row g-2 mb-2">
                  <div class="col-8">
                    <select id="frequency_template" class="form-select form-select-sm">
                      <option value=""><?= __("Select Template..."); ?></option>
                    </select>
                  </div>
                  <div class="col-4 d-grid">
                    <button id="apply_template" class="btn btn-outline-primary btn-sm" type="button"><?= __("Apply"); ?></button>
                  </div>
                </div>

                <div class="d-flex gap-2">
                  <button class="btn btn-success btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#newTemplateModal">+ <?= __("New"); ?></button>
                </div>
              </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title"><?= __("Create New Template"); ?></h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                      <div class="mb-2">
                        <label class="form-label"><?= __("Template Name"); ?></label>
                        <input id="template_name" class="form-control form-control-sm">
                      </div>
                      <div class="row g-2">
                        <div class="col-6 mb-2">
                          <label class="form-label"><?= __("Mode"); ?></label>
                          <input id="template_mode" class="form-control form-control-sm" value="FM">
                        </div>
                        <div class="col-6 mb-2">
                          <label class="form-label"><?= __("Band"); ?></label>
                          <input id="template_band" class="form-control form-control-sm" value="70cm">
                        </div>
                      </div>
                      <div class="row g-2 mt-2">
                        <div class="col-6 mb-2">
                          <label class="form-label"><?= __("TX Freq (MHz)"); ?></label>
                          <input id="template_tx" class="form-control form-control-sm" placeholder="e.g. 439.575">
                        </div>
                        <div class="col-6 mb-2">
                          <label class="form-label"><?= __("RX Freq (MHz)"); ?></label>
                          <input id="template_rx" class="form-control form-control-sm" placeholder="blank = simplex">
                        </div>
                      </div>
                      <div class="mb-2 mt-2">
                        <label class="form-label"><?= __("Comment"); ?></label>
                        <input id="template_comment" class="form-control form-control-sm">
                      </div>
                    </div>
                    <div class="modal-footer">
                      <button class="btn btn-secondary btn-sm" type="button" data-bs-dismiss="modal"><?= __("Cancel"); ?></button>
                      <button id="save_template_btn" class="btn btn-primary btn-sm" type="button"><?= __("Save"); ?></button>
                    </div>
                  </div>
                </div>
              </div>

              <script src="<?php echo $this->paths->cache_buster('/assets/js/qso_templates.js'); ?>"></script>

			<!-- include JS for templates -->
				<script src="<?php echo $this->paths->cache_buster('/assets/js/qso_templates.js'); ?>"></script>
